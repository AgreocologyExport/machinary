...
export function AdminMachineBlogPage({ onNavigate }) {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                ...
                setError("Failed to load machine blogs");
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleDelete = async (blogId) => {
        if (window.confirm("Are you sure you want to delete this machine blog?")) {
            try {
                const blogRef = ref(database, `machine_blogs/${blogId}`);
                await remove(blogRef);
                setBlogs(blogs.filter(blog => blog.id !== blogId));
            } catch (error) {
                console.error("Error deleting machine blog:", error);
                ...
                <div className="blogs-header">
                    <div className="blogs-header-content">
                        ...
                        <div className="header-right">
                            <h1 className="page-title">Manage Machine Blogs</h1>
                            <button onClick={() => onNavigate('machineblogupload')} className="add-blog-button">
                                <Plus size={18} />
                ...
                <div className="blogs-container">
                    ...
                    {loading ? (
                        <div className="loading-state">
                            ...
                            <div style={{ color: '#64748b' }}>Loading machine blogs...</div>
                        </div>
                    ) : blogs.length === 0 ? (
                        <div className="empty-state">
                            <FileText className="empty-icon" size={64} />
                            <div className="empty-title">No machine blog posts yet</div>
                            <div className="empty-subtitle">Get started by creating your first machine blog post</div>
                            <button onClick={() => onNavigate('machineblogupload')} className="add-blog-button">
                                <Plus size={18} />
                                        ...
                                        <div className="blog-info">
                                            ...
                                            <div className="blog-meta">
                                                ...
                                                <div className="blog-actions">
                                                    <button
                                                        onClick={() => onNavigate('machineblogupload', blog.id)}
...
export default AdminMachineBlogPage;
