...
export default function BlogUpload({ onNavigate, blogId }) {
        ...
        <div className="blog-upload-inner">
          ...
          <form onSubmit={handleSubmit}>
            <div className="blog-upload-card">
              ...
              <div className="blog-form-group">
                <label className="blog-label">
                  Short Description<span className="blog-label-required">*</span>
                </label>
                <textarea
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  className="blog-textarea blog-textarea-small"
                  placeholder="Brief summary of your blog post (shown in cards)"
                  required
                  maxLength={200}
                />
              ...
              <div className="blog-form-group">
                <label className="blog-label">
                  Blog Content<span className="blog-label-required">*</span>
                </label>
                <textarea
                  value={content}
                ...
                <div className="blog-hint">
                  💡 Tip: You can use HTML tags like &lt;p&gt;, &lt;h2&gt;, &lt;strong&gt;, &lt;ul&gt;, &lt;img&gt; for formatting
                </div>
              </div>
            </div>
